...
Original file is located at
    https://colab.research.google.com/drive/1sfvQIHksWoxV601wx3oydfOFgGjYqDye
...
def clean_extract(lines):
  for employee in lines:
    ...
    names.append(name)
    call_numbers.append(call_number)
    average_deal_size.append(average_deal_sizes)
    revenues.append(revenue)
  return names,call_numbers,average_deal_sizea,revenues
